...
$stmt = $pdo->prepare("
    SELECT events.event_id, events.event_name, events.start_date, events.start_time, events.location
    FROM events
    JOIN participants ON participants.event_id = events.event_id
        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                ...
                <div class="back-arrow mt-4">
                    <a href="event_details_user.php?user_id=<?php echo $user_id; ?>" class="btn btn-secondary">Back to User</a>
                </div>
            </div>
        </div>
    </div>
